...
Ejecutar con:
  cd /opt/evennia/mudproj/mygame && /opt/evennia/mudproj/venv/bin/pytest tests/test_ciudadela_system.py
"""
import unittest
...
class TestNuevasRecetas(unittest.TestCase):
    ...
    def test_total_recetas_aumentado(self):
        # 12 previas + 8 equipo (v0.24) = 20, más recetas de versiones posteriores
        self.assertEqual(len(RECETAS), 26)
